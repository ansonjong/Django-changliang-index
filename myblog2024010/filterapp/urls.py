...
urlpatterns = [
    ...
    path('filter/convert_sql/', filter_views.display_table_info, name='display_table_info'),
    path('filter/about/', filter_views.about, name='about'),
    path('filter/a/', filter_views.a_view, name='a_view'),
    path('filter/b/', filter_views.b_view, name='b_view'),
    path('filter/convert_sql/', filter_views.submit_table_info, name='submit_table_info'),
    path('filter/process_ddl/', filter_views.process_ddl, name='process_ddl'),
    # path('filter/hive_table/', filter_views.col_info, name='col_info'),
]